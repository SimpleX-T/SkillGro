...
function WorkshopSection() {
	return (
		<section className='bg-white mx-auto px-4 lg:h-[700px] overflow-scroll pt-12 relative'>
			<div className='w-full mx-auto flex mb-16 flex-col justify-between sm:flex-row lg:w-5/6'>
				<img
					src='/about_img.png'
					alt='Boy and girl reading'
					className='hidden lg:block w-[400px]'
				/>
				<div className='w-5/6 text-center lg:text-left mx-auto lg:w-1/2 my-auto'>
					<Tag text='Free Workshop' />

					<h2 className='text-[#161439] text-2xl font-bold my-4 text-center lg:text-left'>
						Join Our Free Workshops
					</h2>

					<p className='text-sm text-[#6D6C80] text-center mx-auto lg:m-none lg:text-left w-full sm:w-1/2 mb-5'>
						An unknown printer took a gallery of type and scrambled
						it to make a type specimen books survived not only five
						centuries.
					</p>

					<div className='flex flex-col sm:flex-row gap-4 w-full sm:w-2/3 mb-4 mx-auto'>
						<div>
			...
			<div className='hidden bg-[#282568] rounded-xl text-white pl-16 pt-4  mb-12 w-5/6 mx-auto lg:flex items-center gap-6'>
